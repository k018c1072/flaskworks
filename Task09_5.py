...
Task09_5 = Flask(__name__)

ALLOWED_EXTENSIONS = set(['png', 'jpg', 'jpeg', 'gif'])
Task09_5.config['UPLOAD_FOLDER'] = './static/uploads'
...
@Task09_5.route('/send', methods=['POST'])
def send():
    print(request.files)
...
@Task09_5.route('/delete', methods=['POST'])
def delete():
...
@Task09_5.route('/data', methods=['GET'])
def data():
